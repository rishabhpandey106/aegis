...
func TestProxyServerDynamicRouting(t *testing.T) {
	...
	upstream := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.Header.Get("X-Aegis-Project-Id") != "" {
			t.Errorf("Expected X-Aegis-Project-Id to be stripped by the proxy")
		}
	...
	t.Run("Valid Route", func(t *testing.T) {
		...
		req.Header.Set("X-Aegis-Project-Id", "valid-project")
	...
	t.Run("Inactive Project", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, proxyTestSrv.URL+"/test", nil)
		req.Header.Set("X-Aegis-Project-Id", "inactive-project")
		resp, _ := http.DefaultClient.Do(req)
		defer resp.Body.Close()
	...
	t.Run("Unknown Project", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, proxyTestSrv.URL+"/test", nil)
		req.Header.Set("X-Aegis-Project-Id", "ghost-project")
		resp, _ := http.DefaultClient.Do(req)
		defer resp.Body.Close()
